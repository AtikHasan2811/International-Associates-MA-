...
class CreateReportsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('reports', function (Blueprint $table) {
            ...
            $table->integer('number_of_security_guards')->nullable();
            $table->integer('number_of_migrant_workers')->nullable();
            $table->text('annual_revenue')->nullable();
            $table->text('currency')->nullable();
            $table->integer('number_of_shipments_to_usa')->nullable();
            $table->integer('port_of_embarkation')->nullable();
            $table->integer('port_of_arrival')->nullable();
            $table->timestamps();
        });
    }
